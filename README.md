...
The app connects to a Supabase/PostgreSQL database (see `supabase/README.md`
for the full setup: applying the 7 migrations, then creating your own
admin account) — no default admin account is auto-created:
